...
integration-s3:
	...
	awslocal s3 cp test_lineitem.tbl.1  s3://integration-test-bucket/test_lineitem.tbl.1
	awslocal s3 cp test_lineitem.tbl.2  s3://integration-test-bucket/test_lineitem.tbl.2